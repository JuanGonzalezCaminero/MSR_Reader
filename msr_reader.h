...
/*
Reads all fields from the msr at msr_address and stores their values in the msr_values array

msr_address: The offset in bytes from the start of the MSR file to the beginning of the MSR
msr_numfields: The number of values to be extracted from the MSR
msr_offsets: An array containing the offset in bits from the start of the MSR to each of the fields
msr_sizes: An array containing the size in bits of each field
